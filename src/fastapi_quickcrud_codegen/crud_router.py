...
from .generator import TemplateGenerator, template_gen
...
from .parse.parse_import import get_imports
    ...
    if sql_type is None:
        ...
        try:
            ...
            raise RuntimeError("Some unknown problem occurred error, maybe you are uvicorn.run with reload=True. "
                               "Try declaring sql_type for crud_router_builder yourself using from fastapi_quickcrud_codegen.misc.type import SqlType")
